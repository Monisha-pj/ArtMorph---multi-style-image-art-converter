# 🎨 ArtMorph — Multi-Style Image Art Converter
...
- ✨ Convert images into multiple art styles:
  ...
  - Sketch  
  - Pixel Art  
- ⚡ Fast, lightweight, and runs locally or on the web  
...
```bash
git clone https://github.com/Monisha-pj/ArtMorph---multi-style-image-art-converter.git
cd ArtMorph---multi-style-image-art-converter
```
